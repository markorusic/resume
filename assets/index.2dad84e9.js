...
`,I=l.h3`
  color: gray;
  font-weight: normal;
`,L=({name:e,avatar:t,title:n,children:i})=>c.createElement(h,null,t&&c.createElement(M,{size:"2"},c.createElement(j,{alt:e+"'s avatar",src:t})),c.createElement(f,{size:"10"},c.createElement("h1",null,e),c.createElement(I,null,n),i)),P=l(h)`
  width: 100%;
  margin: 10px 0;
  @media print {
    margin: 3px 0;
  }
`,N=e=>{var t,n,i=e,{links:r,itemsPerColumn:l=2}=i,m=o(i,["links","itemsPerColumn"]);return c.createElement(P,a({},m),(t=r,n=l,t.slice(0,(t.length+n-1)/n|0).map(((e,i)=>t.slice(n*i,n*i+n)))).map(((e,t)=>c.createElement(f,{key:t,size:"4"},e.map((e=>c.createElement(d,{key:e.id,padding:"5px 0 0 0"},c.createElement(p,{type:e.icon},c.createElement(S,{href:e.url,target:"_blank"},c.createElement(b,null,e.text))))))))))};var O={aboutMe:"About me",workExpirience:"Work Experience",education:"Education",skils:"Skils",projects:"Freelance projects",competitions:"Competitions",workResponsibilities:"Responsibilities"};const R={en:O,sr:{aboutMe:"O meni",workExpirience:"Radno iskustvo",education:"Obrazovanje",skils:"Veštine",projects:"Projekti",competitions:"Takmičenja",workResponsibilities:"Zaduženja"}}[s.lang]||O,C=({position:e,company:t,location:n,description:i,time:r,achievements:a=[]})=>c.createElement(d,{margin:"0 0 30px 0",printMargin:"0 0 7px 0"},c.createElement(k,null,e),c.createElement(d,{margin:"7px 0",printMargin:"3px 0"},c.createElement("div",null,t," ",i&&c.createElement(w,null,"(",i,")"))),c.createElement(d,{margin:"5px 0",printMargin:"1px 0"},c.createElement(z,{time:r,location:n})),c.createElement(w,null,R.workResponsibilities),a.map((e=>c.createElement(v,{key:e.id,title:e.content,url:e.url})))),$=({resume:e})=>c.createElement(u,null,c.createElement(g,null,c.createElement(L,a({},e),c.createElement(N,{links:e.links}))),c.createElement(g,null,c.createElement(h,{justifyContent:"space-between"},c.createElement(f,{size:"6"},e.bio&&e.bio.length>0&&c.createElement(x,{title:R.aboutMe},e.bio.map((e=>c.createElement(d,{key:e,margin:"10px 0 0 0"},c.createElement(b,null,e))))),e.workExperience&&e.workExperience.length>0&&c.createElement(x,{title:R.workExpirience},e.workExperience.map((e=>c.createElement(C,a({key:e.id},e)))))),c.createElement(f,{size:"1"}),c.createElement(f,{size:"5"},e.education&&e.education.length>0&&c.createElement(x,{title:R.education},e.education.map((e=>c.createElement(d,{key:e.id,margin:"0 0 25px 0",printMargin:"0 0 10px 0"},c.createElement(b,{fontSize:"15px"},e.institution),c.createElement(d,{margin:"0 0 5px 0",printMargin:"0 0 2px 0"},c.createElement(b,{fontSize:"14px"},e.name)),c.createElement(z,{time:e.time,location:e.location}))))),e.skils&&e.skils.length>0&&c.createElement(x,{title:R.skils},e.skils.map((e=>c.createElement(T,{key:e},e)))),e.projects&&e.projects.length>0&&c.createElement(x,{title:R.projects},e.projects.map((e=>c.createElement(d,{key:e.id,margin:"0 0 25px 0",printMargin:"0 0 10px 0"},c.createElement(b,{fontSize:"14px"},e.name),c.createElement(v,{title:e.description,url:e.url}))))),e.competitions&&e.competitions.length>0&&c.createElement(x,{title:R.competitions},e.competitions.map((e=>c.createElement(d,{key:e.id,margin:"0 0 25px 0",printMargin:"0 0 10px 0"},c.createElement(b,{fontSize:"14px"},e.name),c.createElement("div",null,c.createElement(w,null,e.description)))))))))),B=()=>c.createElement($,{resume:s}),A=document.getElementById("root");m.exports.render(c.createElement(B,null),A);
